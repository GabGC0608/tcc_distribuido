...
DATABASES={"default":{"ENGINE":"django.db.backends.postgresql","NAME":os.getenv("DB_NAME"),"USER":os.getenv("DB_USER","tcc"),"PASSWORD":os.getenv("DB_PASSWORD","tcc"),"HOST":os.getenv("DB_HOST","localhost"),"PORT":os.getenv("DB_PORT","5432")}}
...
DATA_UPLOAD_MAX_MEMORY_SIZE=52428800; FILE_UPLOAD_MAX_MEMORY_SIZE=52428800
