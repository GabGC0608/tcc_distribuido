...
class Member(models.Model):
 id=models.UUIDField(primary_key=True,default=uuid.uuid4,editable=False); defense_id=models.UUIDField(); user_id=models.UUIDField(null=True,blank=True); name=models.CharField(max_length=200); email=models.EmailField(); external=models.BooleanField(default=False); token=models.CharField(max_length=128,unique=True,default=generate_member_token); available=models.BooleanField(default=False); confirmed_at=models.DateTimeField(null=True,blank=True)
